      ...
      uni.uploadFile({
        ...
        success: (res) => {
          if (res.statusCode === 200) {
            ...
            // store 头像更新
            menberStore.profile!.avatar = avatar
            uni.showToast({
              icon: 'success',
              title: '更新成功',
            })
...
const onSubmit = async () => {
  ...
  // 更新store
  menberStore.profile!.nickname = res.result.nickname
  setTimeout(() => {
    uni.showToast({
      icon: 'success',
      title: '更新成功',
    ...
    <view class="form">
      ...
      <view class="form-content">
        ...
        <view class="form-item">
          ...
          <input class="input" type="text" placeholder="请填写职业" value="牛逼的程序员" />
        </view>
      </view>
      <!-- 提交按钮 -->
