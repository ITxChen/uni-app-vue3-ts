...
import { OrderState, orderStateList } from '@/services/content'
    ...
    <template v-if="order">
      ...
      <view class="goods">
        <view class="item">
          ...
          <!-- 待评价状态:展示按钮 -->
          <view class="action" v-if="OrderState.DaiPingJia">
  ...
  <uni-popup ref="popup" type="bottom" background-color="#fff">
    <view class="popup-root">
      ...
      <view class="footer">
        ...
        <view class="button primary" @tap="confimClose">确认</view>
      </view>
    </view>
  </uni-popup>
</template>
